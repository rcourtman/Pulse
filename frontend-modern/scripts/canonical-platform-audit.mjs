...
const HELPER_RULES = [
  ...
  {
    rule: 'canonical-settings/no-local-monitored-system-ledger-copy',
    regex: /Loading monitored system ledger\.\.\.|Failed to load monitored system ledger\./g,
    message:
      'Do not define local monitored-system ledger loading or error copy in component code. Use @/utils/unifiedAgentInventoryPresentation instead.',
  },
  {
