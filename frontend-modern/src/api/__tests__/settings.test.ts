...
const mockTelemetryPreviewPayload = {
  ...
  alert_ai_enabled: false,
  ai_provider_class: 'none',
  active_alerts: 0,
  relay_enabled: false,
  sso_enabled: false,
  multi_tenant: false,
  ...
  audit_reads_30d: 0,
  report_schedules: 0,
  report_schedules_enabled: 0,
  report_schedules_run_30d: 0,
  agent_profiles: 0,
  ...
  workload_history_preview_sessions_30d: 0,
  workload_history_scrub_sessions_30d: 0,
  ...
  pulse_intelligence_patrol_blocked_cause: undefined,
  pulse_intelligence_patrol_autonomy_level: 'monitor',
  pulse_intelligence_patrol_input_tokens_bucket_30d: 'zero',
  pulse_intelligence_patrol_output_tokens_bucket_30d: 'zero',
  pulse_intelligence_patrol_investigation_outcome_fix_verified_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_fix_queued_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_fix_executed_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_fix_rejected_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_fix_failed_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_fix_verification_unknown_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_resolved_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_needs_attention_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_cannot_fix_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_timed_out_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_in_progress_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_failed_30d: 0,
  pulse_intelligence_patrol_investigation_outcome_other_30d: 0,
  ...
  pulse_intelligence_patrol_action_plans_30d: 0,
  pulse_intelligence_patrol_approval_requests_30d: 0,
  pulse_intelligence_patrol_rejected_action_decisions_30d: 0,
  pulse_intelligence_patrol_approved_action_decisions_30d: 0,
  pulse_intelligence_patrol_approved_action_attempts_30d: 0,
  pulse_intelligence_patrol_approved_action_successes_30d: 0,
  ...
  pulse_intelligence_approved_action_refusals_target_changed_30d: 0,
  pulse_intelligence_approved_action_refusals_prerequisite_30d: 0,
  pulse_intelligence_approved_action_refusals_contract_30d: 0,
  pulse_intelligence_approved_action_refusals_other_30d: 0,
  pulse_intelligence_approved_action_refusals_uncoded_30d: 0,
