...
// Source SHA256: 16bcaabb45bed31b4bbd414e4e665dac63591ea1ac0e739464808381eb58e004

export const PLATFORM_SUPPORT_MANIFEST_SOURCE = {
  path: 'docs/release-control/v6/internal/PLATFORM_SUPPORT_MANIFEST.json',
  sha256: '16bcaabb45bed31b4bbd414e4e665dac63591ea1ac0e739464808381eb58e004',
} as const;
export const PLATFORM_SUPPORT_MANIFEST = {
  ...
  platforms: [
    ...
    },
    {
      ...
      uiLabel: 'Unraid',
      uiTone: 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-200',
      aliases: [],
...
export const SOURCE_PLATFORM_SURFACE_KIND = {
  agent: 'platform',
  docker: 'runtime-lens',
  kubernetes: 'platform',
  'proxmox-pve': 'platform',
  'proxmox-pbs': 'platform',
  'proxmox-pmg': 'platform',
  truenas: 'platform',
...
export type PlatformSurfaceKind = (typeof SOURCE_PLATFORM_MANIFEST_ENTRIES)[number]['surfaceKind'];
