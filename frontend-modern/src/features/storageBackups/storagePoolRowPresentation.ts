...
export const STORAGE_POOL_ROW_NAME_CELL_CLASS =
  'overflow-hidden px-1.5 sm:px-2 py-1 align-middle text-base-content';
...
export const STORAGE_POOL_ROW_TYPE_CELL_CLASS =
  'overflow-hidden px-2 py-1 align-middle text-[11px] text-base-content';
export const STORAGE_POOL_ROW_HOST_CELL_CLASS =
  'overflow-hidden px-1.5 sm:px-2 py-1 align-middle text-[11px] text-base-content';
export const STORAGE_POOL_ROW_TEXT_TRUNCATE_CLASS = 'block truncate';
export const STORAGE_POOL_ROW_PROTECTION_CELL_CLASS =
  'overflow-hidden px-1.5 sm:px-2 py-1 align-middle text-[11px]';
export const STORAGE_POOL_ROW_PROTECTION_TEXT_CLASS = 'block truncate font-semibold';
export const STORAGE_POOL_ROW_USAGE_CELL_CLASS = 'overflow-hidden px-1.5 sm:px-2 py-1 align-middle';
...
export const STORAGE_POOL_ROW_GROWTH_CELL_CLASS =
  'overflow-hidden px-2 py-1 align-middle text-[11px]';
