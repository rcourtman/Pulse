                      ...
                      {(node) => {
                        ...
                        return (
                          <TableRow>
                            ...
                            <TableCell
                              class={`${getPlatformTableCellClassForKind('text')} text-[11px] text-base-content`}
                            >
                            ...
                            <TableCell
                              class={`${getPlatformTableCellClassForKind('numeric-value')} text-[11px] text-base-content tabular-nums`}
                            >
