    ...
    <>
      ...
      <Show when={props.activeTab() === 'thresholds'}>
        <ThresholdsTab
          ...
          setKubernetesDefaults={state.setKubernetesDefaults}
          trueNASDefaults={state.trueNASDefaults}
          setTrueNASDefaults={state.setTrueNASDefaults}
          trueNASDiskDefaults={state.trueNASDiskDefaults}
          setTrueNASDiskDefaults={state.setTrueNASDiskDefaults}
          vmwareDefaults={state.vmwareDefaults}
          setVMwareDefaults={state.setVMwareDefaults}
          ...
          disableAllKubernetes={state.disableAllKubernetes}
          setDisableAllKubernetes={state.setDisableAllKubernetes}
          disableAllTrueNAS={state.disableAllTrueNAS}
          setDisableAllTrueNAS={state.setDisableAllTrueNAS}
          disableAllVMware={state.disableAllVMware}
          setDisableAllVMware={state.setDisableAllVMware}
          ...
          resetKubernetesDefaults={state.resetKubernetesDefaults}
          resetTrueNASDefaults={state.resetTrueNASDefaults}
          resetTrueNASDiskDefaults={state.resetTrueNASDiskDefaults}
          resetVMwareDefaults={state.resetVMwareDefaults}
          ...
          factoryKubernetesDefaults={state.factoryKubernetesDefaults}
          factoryTrueNASDefaults={state.factoryTrueNASDefaults}
          factoryTrueNASDiskDefaults={state.factoryTrueNASDiskDefaults}
          factoryVMwareDefaults={state.factoryVMwareDefaults}
