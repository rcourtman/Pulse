...
export const EN_MESSAGES = {
  'home.title': 'Home',
  'home.description': 'Verified health across every monitored resource.',
  'home.nav.tooltip': 'See verified health across the whole fleet',
  'home.refresh.label': 'Refresh',
  'home.refresh.ariaLabel': 'Refresh fleet health',
  ...
  'home.platform.docker': 'Docker and Podman',
  'home.platform.kubernetes': 'Kubernetes',
  'home.platform.truenas': 'TrueNAS',
  'home.platform.vmware': 'vSphere',
  'home.platform.standalone': 'Machines and checks',
  'home.platform.other': 'Other resources',
  'home.verdict.ok': 'Healthy',
  'home.verdict.attention': 'Needs attention',
  'home.verdict.critical': 'Critical',
  'home.verdict.stale': 'Stale',
  'home.verdict.off': 'Powered off',
  'home.verdict.unknown': 'Unknown',
  'home.reason.criticalAlert': 'Critical alert{detail}',
  'home.reason.warningAlert': 'Warning alert{detail}',
  'home.reason.availabilityFailed': 'Availability check failed',
  'home.reason.offline': 'Offline',
  'home.reason.backupStale': 'Backup stale{detail}',
  'home.reason.telemetryStale': 'Telemetry stale{detail}',
  'home.reason.telemetryMissing': 'Telemetry missing',
  'home.reason.poweredOff': 'Powered off',
  'home.reason.degraded': 'Degraded',
  'home.tile.ariaLabel': '{name}: {status}. {reason}',
  'home.group.showAll': 'Show all ({count})',
  'home.group.showLess': 'Show less',
