...
export const ES_MESSAGE_OVERRIDES = {
  'home.title': 'Inicio',
  'home.description': 'Estado verificado de cada recurso monitorizado.',
  'home.nav.tooltip': 'Ver el estado verificado de toda la flota',
  'home.refresh.label': 'Actualizar',
  'home.refresh.ariaLabel': 'Actualizar estado de la flota',
  ...
  'home.empty.description':
    'Agrega una API de plataforma, Pulse Agent o una comprobacion de disponibilidad para comenzar a verificar los recursos.',
  ...
  'home.platform.docker': 'Docker y Podman',
  'home.platform.kubernetes': 'Kubernetes',
  'home.platform.truenas': 'TrueNAS',
  'home.platform.vmware': 'vSphere',
  'home.platform.standalone': 'Maquinas y comprobaciones',
  'home.platform.other': 'Otros recursos',
  'home.verdict.ok': 'Saludable',
  'home.verdict.attention': 'Necesita atencion',
  'home.verdict.critical': 'Critico',
  'home.verdict.stale': 'Obsoleto',
  'home.verdict.off': 'Apagado',
  'home.verdict.unknown': 'Desconocido',
  'home.reason.criticalAlert': 'Alerta critica{detail}',
  'home.reason.warningAlert': 'Alerta de advertencia{detail}',
  'home.reason.availabilityFailed': 'La comprobacion de disponibilidad fallo',
  'home.reason.offline': 'Sin conexion',
  'home.reason.backupStale': 'Copia de seguridad obsoleta{detail}',
  'home.reason.telemetryStale': 'Telemetria obsoleta{detail}',
  'home.reason.telemetryMissing': 'Falta telemetria',
  'home.reason.poweredOff': 'Apagado',
  'home.reason.degraded': 'Degradado',
  'home.tile.ariaLabel': '{name}: {status}. {reason}',
  'home.group.showAll': 'Mostrar todo ({count})',
  'home.group.showLess': 'Mostrar menos',
  ...
  'alerts.overview.action.snooze': 'Posponer',
  'alerts.overview.action.unacknowledge': 'Quitar reconocimiento',
  'alerts.overview.group.acknowledge': 'Reconocer todas ({count})',
  'alerts.overview.group.hide': 'Ocultar',
  'alerts.overview.group.linkedSignal': '+{count} senal vinculada',
  'alerts.overview.group.linkedSignals': '+{count} senales vinculadas',
  'alerts.overview.group.related': '+{count} relacionadas',
  'alerts.overview.synthesis.title.supported': 'Causa de infraestructura respaldada',
  'alerts.overview.synthesis.title.observationSet': 'Conjunto de observaciones relacionadas',
  'alerts.overview.synthesis.failure.runtime': 'Ejecucion',
  'alerts.overview.synthesis.failure.networkPath': 'Ruta de red',
  'alerts.overview.synthesis.failure.applicationResponse': 'Respuesta de aplicacion',
  ...
  'alerts.overview.synthesis.challenge.observationSet':
    'Estas observaciones estan relacionadas, pero Pulse no ha establecido una causa raiz.',
  ...
  'alerts.overview.notification.resumed': 'Notificaciones de alerta reanudadas',
  'alerts.overview.notification.resumeFailed': 'No se pudieron reanudar las notificaciones',
  'alerts.overview.notification.snoozed': 'Alerta pospuesta hasta {until}',
  'alerts.overview.notification.snoozeFailed': 'No se pudo posponer la alerta',
  ...
  'alerts.overview.snooze.option.oneHour': 'Durante 1 hora',
  'alerts.overview.snooze.option.sevenDays': 'Durante 7 dias',
  'alerts.overview.snooze.option.tomorrowMorning': 'Hasta manana a las 9:00',
  'alerts.overview.snooze.option.twoHours': 'Durante 2 horas',
  'alerts.overview.snooze.title': 'Posponer esta alerta',
  'alerts.overview.snoozedUntil': 'Pospuesta hasta {until}',
  ...
  'alerts.timeline.event.alertSnoozed': 'Pospuesta',
  'alerts.timeline.event.alertUnsnoozed': 'Reanudada',
