...
export const DE_MESSAGE_OVERRIDES = {
  'home.title': 'Start',
  'home.description': 'Bestaetigte Integritaet aller ueberwachten Ressourcen.',
  'home.nav.tooltip': 'Bestaetigten Zustand der gesamten Flotte anzeigen',
  'home.refresh.label': 'Aktualisieren',
  'home.refresh.ariaLabel': 'Flottenzustand aktualisieren',
  ...
  'home.empty.description':
    'Fuegen Sie eine Plattform-API, einen Pulse Agent oder eine Verfuegbarkeitspruefung hinzu, um den Ressourcenzustand zu bestaetigen.',
  ...
  'home.platform.docker': 'Docker und Podman',
  'home.platform.kubernetes': 'Kubernetes',
  'home.platform.truenas': 'TrueNAS',
  'home.platform.vmware': 'vSphere',
  'home.platform.standalone': 'Maschinen und Pruefungen',
  'home.platform.other': 'Andere Ressourcen',
  'home.verdict.ok': 'Fehlerfrei',
  'home.verdict.attention': 'Aufmerksamkeit erforderlich',
  'home.verdict.critical': 'Kritisch',
  'home.verdict.stale': 'Veraltet',
  'home.verdict.off': 'Ausgeschaltet',
  'home.verdict.unknown': 'Unbekannt',
  'home.reason.criticalAlert': 'Kritische Warnung{detail}',
  'home.reason.warningAlert': 'Warnung{detail}',
  'home.reason.availabilityFailed': 'Verfuegbarkeitspruefung fehlgeschlagen',
  'home.reason.offline': 'Offline',
  'home.reason.backupStale': 'Sicherung veraltet{detail}',
  'home.reason.telemetryStale': 'Telemetrie veraltet{detail}',
  'home.reason.telemetryMissing': 'Telemetrie fehlt',
  'home.reason.poweredOff': 'Ausgeschaltet',
  'home.reason.degraded': 'Beeintraechtigt',
  'home.tile.ariaLabel': '{name}: {status}. {reason}',
  'home.group.showAll': 'Alle anzeigen ({count})',
  'home.group.showLess': 'Weniger anzeigen',
