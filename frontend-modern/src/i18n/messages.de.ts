...
export const DE_MESSAGE_OVERRIDES = {
  ...
  'alerts.overview.notification.resumed': 'Warnmeldungen werden fortgesetzt',
  'alerts.overview.notification.resumeFailed': 'Warnmeldungen konnten nicht fortgesetzt werden',
  'alerts.overview.notification.snoozed': 'Warnmeldung zurueckgestellt bis {until}',
  'alerts.overview.notification.snoozeFailed': 'Warnmeldung konnte nicht zurueckgestellt werden',
  ...
  'alerts.overview.snooze.option.oneHour': 'Fuer 1 Stunde',
  'alerts.overview.snooze.option.sevenDays': 'Fuer 7 Tage',
  'alerts.overview.snooze.option.tomorrowMorning': 'Bis morgen um 9:00',
  'alerts.overview.snooze.option.twoHours': 'Fuer 2 Stunden',
  'alerts.overview.snooze.title': 'Warnmeldung zurueckstellen',
  'alerts.overview.snoozedUntil': 'Zurueckgestellt bis {until}',
  ...
  'alerts.timeline.event.alertSnoozed': 'Zurueckgestellt',
  'alerts.timeline.event.alertUnsnoozed': 'Fortgesetzt',
