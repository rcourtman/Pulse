    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-2.5">
      <a href={INFRASTRUCTURE_PATH} class="group block">
        <Card
          ...
          border={false}
          padding="none"
          class="h-full px-3.5 py-2.5 bg-surface-alt group-hover:bg-surface-hover transition-colors"
        >
      ...
      <a href={WORKLOADS_PATH} class="group block">
        ...
        >
          ...
          <p class="text-xs text-muted mt-0.5">
            <span class="font-mono font-medium text-base-content">{props.workloads.running}</span>{' '}
            running
          </p>
        </Card>
      </a>
      ...
      <a href={ALERTS_OVERVIEW_PATH} class="group block">
        <Card
          ...
          border={false}
          padding="none"
          class="h-full px-3.5 py-2.5 group-hover:brightness-95 dark:group-hover:brightness-110 transition-all"
        >
