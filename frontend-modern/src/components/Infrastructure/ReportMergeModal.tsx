  ...
  return (
    ...
    >
      <div class="flex items-start justify-between border-b border-border px-5 py-4">
        <div>
          <h3 id={dialogTitleId()} class="text-lg font-semibold text-base-content">
            Split Merged Resource
          </h3>
          <p id={dialogDescriptionId()} class="mt-1 text-xs text-muted">
            Use this when two systems were combined incorrectly. Pulse will keep them separate on
            future refreshes.
          </p>
        </div>
        <button
      ...
      <div class="flex-1 overflow-y-auto space-y-4 px-5 py-4 text-sm text-base-content">
        <div>
          <div class="text-xs font-medium uppercase tracking-wide text-muted">Resource</div>
