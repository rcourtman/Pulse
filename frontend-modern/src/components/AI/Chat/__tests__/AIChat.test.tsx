  ...
  describe('rendering', () => {
    ...
    it('does not offer provider route recovery for local fixture failures', async () => {
      const localFixtureFailure: ChatMessage = {
        ...
        content: '',
        error:
          'Unknown Assistant fixture "/fixture typo-check". Available fixtures: devices, assistant-stream, send-hold, tool-burst, tool-chain, workflow-burst, context-group, status-boundary, pending-tool, command-tool, long-output, provider-retry, stream-idle, queue-hold, queue-drain, compacted-artifact, skipped-tool.',
        timestamp: new Date('2026-06-05T10:00:00Z'),
