  ...
  return (
    <div class="my-2 font-mono text-xs">
      ...
      <button
        ...
        class="w-full flex items-center gap-2 px-3 py-1.5 rounded-md bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors text-left group"
      >
        {/* Thinking icon */}
