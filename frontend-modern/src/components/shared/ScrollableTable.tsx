  ...
  return (
    <div class={`relative ${props.class || ''}`}>
      ...
      <Show when={showLeftFade()}>
        <div class="absolute left-0 top-0 bottom-0 w-8 bg-white dark:bg-slate-800 z-10 pointer-events-none" />
      </Show>
      ...
      <Show when={showRightFade()}>
        <div class="absolute right-0 top-0 bottom-0 w-8 bg-white dark:bg-slate-800 z-10 pointer-events-none" />
      </Show>
    </div>
  );
};
