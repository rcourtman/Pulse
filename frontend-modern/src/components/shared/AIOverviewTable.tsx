    ...
    const unifiedRows = (): InsightRow[] => {
        ...
        for (const change of visibleChanges) {
            ...
            rows.push({
                ...
                subtitle: change.description || 'Change detected by Pulse Patrol.',
                    ...
                    <div class="flex items-center justify-between flex-wrap gap-2">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="font-semibold text-gray-900 dark:text-gray-100">Pulse Intelligence Summary</span>
                            </div>
                            ...
                            <div class="px-4 py-8 text-center">
                                <div class="inline-flex flex-col items-center gap-2">
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        No Pulse insights yet. Pulse will learn patterns and surface intelligence over time.
                                    </p>
                                </div>
                            </div>
                        }
                        ...
                        <div class="flex flex-wrap items-center gap-4 text-xs">
                            <Show when={insightsLocked()}>
                                <div class="flex items-center gap-1 text-amber-700 dark:text-amber-300">
                                    ...
                                    <span>{insightsLockedCount()} Pulse Insights locked</span>
                                </div>
                            </Show>
