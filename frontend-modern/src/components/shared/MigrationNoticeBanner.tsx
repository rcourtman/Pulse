...
export const MigrationNoticeBanner: Component<MigrationNoticeBannerProps> = (props) => {
  return (
    <div class="rounded-md border border-blue-200 bg-blue-50 px-3 py-2 text-blue-900 shadow-sm dark:border-blue-800 dark:bg-blue-950 dark:text-blue-100">
      <div class="flex items-start justify-between gap-3">
        <div class="min-w-0">
          ...
          <div class="mt-0.5 text-xs text-blue-800 dark:text-blue-200">{props.message}</div>
        ...
        <button
          ...
          class="inline-flex h-6 w-6 items-center justify-center rounded-md text-blue-700 hover:bg-blue-100 hover:text-blue-900 dark:text-blue-300 dark:hover:bg-blue-900 dark:hover:text-blue-100"
          title="Dismiss"
