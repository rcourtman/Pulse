      ...
      <span class="relative flex shrink-0 items-center justify-center">
          ...
          {(badges) => (
            <span aria-hidden="true" class="absolute -right-2 -top-1 flex items-center gap-1">
              ...
              <Show when={badges().warning > 0}>
                <span class="inline-flex h-4 min-w-[16px] items-center justify-center rounded-full bg-amber-200 px-1 text-[10px] font-semibold text-amber-900/100">
                  {badges().warning}
                </span>
              </Show>
            </span>
        ...
        <Show when={genericCount()}>
          {(count) => (
            <span
              aria-hidden="true"
              class="absolute -right-2 -top-1 inline-flex h-4 min-w-[16px] items-center justify-center rounded-full bg-amber-200 px-1 text-[10px] font-semibold text-amber-900/100"
            >
              {count()}
            </span>
          )}
