  ...
  return (
    <>
      ...
      <button
        type="button"
        onClick={scrollToTop}
        class={`fixed bottom-6 right-6 z-30 flex h-9 w-9 items-center justify-center rounded-full bg-surface text-base-content shadow-sm transition-all duration-200 hover:bg-surface-hover border border-border md:bottom-6 bottom-20 ${
