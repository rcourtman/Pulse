...
export const NodeDrawer: Component<NodeDrawerProps> = (props) => {
  ...
  createEffect(() => {
    ...
    HostMetadataAPI.getMetadata(hostId)
      .then((meta) => {
          ...
          <div class="rounded border border-gray-200 bg-white/70 p-3 shadow-sm dark:border-gray-600/70 dark:bg-gray-900/30">
            ...
            <div class="space-y-1.5 text-[11px]">
              <div class="flex items-center justify-between gap-2 min-w-0">
                ...
                <span
                  class="font-medium text-gray-700 dark:text-gray-200 select-all truncate"
          ...
          <div class="rounded border border-gray-200 bg-white/70 p-3 shadow-sm dark:border-gray-600/70 dark:bg-gray-900/30">
            ...
            <div class="space-y-1.5 text-[11px]">
              <div class="flex items-center justify-between">
                ...
                <div
                  class="font-medium text-gray-700 dark:text-gray-200 text-right truncate max-w-[150px]"
                  title={props.node.cpuInfo?.model || 'Unknown'}
                >
