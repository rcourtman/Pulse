...
const QueueIndicator: Component<{
  queue?: {
    total: number;
    active?: number;
    deferred?: number;
          ...
          <div class="flex flex-wrap gap-x-6 gap-y-1 text-xs">
            ...
            <div class="flex items-center gap-2">
              ...
              <span class="font-medium text-base-content">
                {formatNum(stats().bouncesIn)}/{formatNum(stats().bouncesOut)}
              </span>
            </div>
            <Show when={props.pmg.mailStats?.averageProcessTimeMs}>
              <div class="flex items-center gap-2">
                ...
                <span class="font-medium text-base-content">
                  {formatDec((props.pmg.mailStats?.averageProcessTimeMs || 0) / 1000, 2)}s
                </span>
              </div>
            </Show>
          </div>
          ...
          <div class="mt-3 pt-3 border-t border-border">
            ...
            <div class="flex gap-1 overflow-x-auto pb-1">
              <For each={props.pmg.spamDistribution}>
                {(bucket) => {
                  const totalScored =
                    props.pmg.spamDistribution?.reduce((sum, b) => sum + b.count, 0) || 1;
