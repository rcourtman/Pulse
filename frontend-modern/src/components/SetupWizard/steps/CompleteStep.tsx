      ...
      <div class="relative z-10">
        ...
        <div class="bg-surface rounded-md border border-border p-6 text-left mb-6">
          ...
          <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-4">
            ...
            <div class="bg-surface-alt border border-border rounded-md p-3 text-center transition-colors">
              <div class="h-6 flex items-center justify-center mb-2">
                <span class="text-[13px] text-cyan-600 dark:text-cyan-400 font-bold tracking-tight">
                  NAS
                </span>
              </div>
        ...
        <div class="bg-surface rounded-md border border-border p-6 text-left mb-6">
          ...
          <div class=" rounded-md p-4 font-mono text-xs mb-3 relative group border border-border">
            <code class="text-emerald-600 dark:text-emerald-400 break-all block leading-relaxed pr-8">
              {getInstallCommand()}
            </code>
            <button
            ...
            >
              {copied() === 'install' ? (
                ...
                <svg
                  class="w-4 h-4 text-muted group-hover:text-base-content"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div class="pt-4 border-t border-border">
          ...
          <p class="mt-4 text-xs text-muted">You can add more agents anytime from Settings</p>
        </div>
