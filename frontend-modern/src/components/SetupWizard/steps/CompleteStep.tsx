...
`;
    ...
    return (
        <div class="card max-w-2xl mx-auto backdrop-blur-xl bg-white/70 dark:bg-slate-800/70 border border-slate-200/50 dark:border-slate-700/50 overflow-hidden shadow-2xl animate-fade-in relative rounded-2xl p-6 sm:p-8 text-center text-slate-900 dark:text-white">
            ...
            <div class="relative z-10">
                ...
                <Show when={connectedAgents().length > 0}>
                    <div class="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl border border-emerald-200 dark:border-emerald-800 p-5 text-left mb-6 shadow-sm">
                        ...
                        <div class="space-y-2">
                            <For each={connectedAgents()}>
                                {(agent) => (
                                    <div class="flex items-center justify-between bg-white dark:bg-slate-900/50 rounded-lg px-3 py-2.5 border border-slate-100 dark:border-slate-800 shadow-sm">
                ...
                {/* Auto-detection info */}
                <div class="bg-white dark:bg-slate-900/80 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 text-left mb-6">
                ...
                <div class="bg-white dark:bg-slate-900/80 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm p-6 text-left mb-6">
                    ...
                    <div class="bg-slate-50 dark:bg-black/40 rounded-xl p-4 font-mono text-xs mb-3 relative group border border-slate-200 dark:border-slate-700/50 shadow-inner">
                ...
                <div class="bg-white dark:bg-slate-900/80 rounded-xl border border-slate-200 dark:border-slate-700 mb-8 overflow-hidden shadow-sm">
                    <button
                ...
                <div class="pt-4 border-t border-slate-200 dark:border-slate-800">
                    <button
                        ...
                        class="w-full py-4 px-6 bg-blue-600 hover:bg-blue-700 text-white text-base font-semibold rounded-xl shadow-[0_4px_14px_0_rgba(37,99,235,0.39)] hover:shadow-[0_6px_20px_rgba(37,99,235,0.23)] transition-all duration-200"
                    >
                ...
                <Show when={connectedAgents().length > 0}>
                    <div class="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-100 dark:border-indigo-800/50 p-5 text-left mt-8 shadow-sm overflow-hidden relative">
                        <div class="absolute -right-4 -top-4 w-24 h-24 bg-indigo-500/10 dark:bg-indigo-500/20 rounded-full blur-2xl"></div>
