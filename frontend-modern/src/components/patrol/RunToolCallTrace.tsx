    ...
    <Show when={props.toolCallCount > 0}>
      <div class="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
        <button
          ...
          class="flex items-center gap-2 text-xs font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100"
        >
          <svg
        ...
        <Show when={expanded()}>
          <Show when={toolCalls.loading}>
            <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400 py-2 mt-2">
                ...
                {(call: ToolCallRecord, index) => (
                  <div class="border border-gray-200 dark:border-gray-700 rounded">
                    <button
                      ...
                      class="w-full flex items-center justify-between gap-2 px-2 py-1.5 text-xs hover:bg-gray-50 dark:hover:bg-gray-800/50"
                    >
                      <div class="flex items-center gap-2 min-w-0">
                        <span class="text-gray-400 dark:text-gray-500 font-mono w-5 text-right flex-shrink-0">
                          {index() + 1}.
                        </span>
                        <span class="font-medium text-gray-800 dark:text-gray-200 font-mono truncate">
                          {call.tool_name}
                        </span>
                      </div>
                    ...
                    <Show when={expandedCall() === call.id}>
                      <div class="border-t border-gray-200 dark:border-gray-700 p-2 space-y-2">
                        <Show when={call.input}>
                          <div>
                            <div class="text-[10px] font-medium text-gray-500 dark:text-gray-400 mb-1">Input</div>
                            <pre class="text-[11px] font-mono bg-gray-50 dark:bg-gray-900 rounded p-2 max-h-32 overflow-auto whitespace-pre-wrap text-gray-700 dark:text-gray-300">
                        ...
                        <Show when={call.output}>
                          <div>
                            <div class="text-[10px] font-medium text-gray-500 dark:text-gray-400 mb-1">Output</div>
                            <pre class="text-[11px] font-mono bg-gray-50 dark:bg-gray-900 rounded p-2 max-h-32 overflow-auto whitespace-pre-wrap text-gray-700 dark:text-gray-300">
