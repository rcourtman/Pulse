            ...
            <div class="space-y-1.5 text-[11px]">
              ...
              <div class="flex items-center justify-between gap-2 min-w-0">
                ...
                <span
                  ...
                  title={`${props.host.osName} ${props.host.osVersion}`}
                >
                  ...
                  {(disk) => (
                    <div class="text-[10px]">
                      <div class="flex justify-between mb-0.5">
                        <span
                          class="text-gray-600 dark:text-gray-300 truncate max-w-[120px]"
                      ...
                      <div class="h-1.5 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${Math.min(100, Math.max(0, (disk.used / disk.total) * 100))}%`,
                          }}
                        />
                      </div>
                    </div>
