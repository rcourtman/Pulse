...
export function useSettingsInfrastructurePanelProps(
  ...
  const getInfrastructurePanelProps = (): InfrastructurePlatformSettingsProps => ({
    ...
    handleDiscoveryModeChange: params.infrastructureSettings.handleDiscoveryModeChange,
    ...
    commitDiscoverySubnet: params.infrastructureSettings.commitDiscoverySubnet,
