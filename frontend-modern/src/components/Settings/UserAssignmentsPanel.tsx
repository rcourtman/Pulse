              ...
              <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <For each={roles()}>
                    {(role) => (
                      <label
                        class={`flex flex-col p-3 rounded-md border transition-all cursor-pointer ${formRoleIds().includes(role.id) ? 'bg-blue-50 border-blue-200 dark:bg-blue-900 dark:border-blue-800' : 'bg-surface border-border hover:border-blue-100 dark:hover:border-blue-900'}`}
                      >
              ...
              <div class="space-y-4 pt-4 border-t border-border-subtle">
                ...
                <div class="bg-surface-hover rounded-md p-4 border border-border-subtle">
                  ...
                  <p class="mt-4 text-[10px] text-muted uppercase tracking-widest font-bold">
                    Note: Permissions are recalculated on save. This preview shows current
                    server-side state.
                  </p>
                </div>
              </div>
