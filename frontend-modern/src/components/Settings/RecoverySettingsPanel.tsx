          ...
          <div class="space-y-3">
            ...
            <Show when={props.backupPollingEnabled()}>
              <div class="space-y-3 rounded-md border border-border p-3">
                <FormSelect
                  id="recovery-backup-polling-interval"
                  label={
                    <span>
                      <span class="block text-sm font-medium text-base-content">
                        Polling interval
                      </span>
                      <span aria-hidden="true" class="block text-xs font-normal text-muted">
                  ...
                  fieldBaseClass="flex"
                  fieldClass="flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"
                  selectBaseClass="w-full sm:w-auto min-h-10 sm:min-h-9 px-3 py-2.5 text-sm border border-border rounded-md bg-surface disabled:opacity-50"
                >
              ...
              <div class="flex items-start gap-2 rounded-md border border-amber-200 bg-amber-50 dark:border-amber-700 dark:bg-amber-900 p-3 text-xs text-amber-700 dark:text-amber-200">
                ...
                <div>
                  ...
                  <p class="mt-1">
                    ...
                    <code class="font-mono">BACKUP_POLLING_INTERVAL</code> environment variables are
                    set. Remove them and restart Pulse to manage backup polling here.
                  </p>
                </div>
              </div>
            </Show>
          ...
          <div class="group border border-border rounded-md p-5 bg-blue-50 dark:bg-blue-900 hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200">
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1 min-w-0">
                <h4 class="text-base font-semibold text-base-content mb-1">Export Configuration</h4>
                <p class="text-sm text-muted mb-3">Create an encrypted backup package</p>
          ...
          <div class="group border border-border rounded-md p-5 bg-surface-alt hover:border-border transition-all duration-200">
            <div class="flex items-start gap-4">
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-muted mb-3">Import from an encrypted backup file</p>
