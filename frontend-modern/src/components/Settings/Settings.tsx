...
const Settings: Component<SettingsProps> = (props) => {
 ...
 class="p-1 rounded-md hover: transition-colors"
 ...
 class="w-full p-2 rounded-md hover: transition-colors"
 ...
 <div class={`flex items-center justify-center rounded-md lg:rounded-none w-8 h-8 lg:w-auto lg:h-auto ${isActive() ? 'bg-blue-100 dark:bg-blue-900 lg:bg-transparent text-blue-600 dark:text-blue-400' : 'bg-surface-alt lg:bg-transparent text-muted lg:text-inherit'}`}>
 ...
 <div class="lg:hidden sticky top-0 z-40 bg-white/95/95 border-b border-border-subtle px-3 py-2.5 flex items-center shadow-none">
 <button
 type="button"
 ...
 class={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${disableDockerUpdateActions()
 ? 'bg-blue-600'
 : 'bg-surface-alt'
