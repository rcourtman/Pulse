...
import { getStatusIndicatorBadgeToneClasses } from '@/utils/status';
...
export const PveNodesTable: Component<PveNodesTableProps> = (props) => {
  return (
    <Card padding="none" tone="card" class="rounded-md">
      <Table
        wrapperClass="max-h-[600px] overflow-y-auto"
        class="min-w-[max-content] w-full divide-y divide-border text-sm"
      >
