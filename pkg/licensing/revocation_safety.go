...
func (s *SafeEvaluator) CheckLimit(key string, observed int64) LimitCheckResult {
	return safeCall("check_limit", key, "limit_allowed", &observed, LimitAllowed, func() LimitCheckResult {
