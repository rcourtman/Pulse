...
// server) produce identical wire output. This catches drift between canonical
// and legacy limit aliases that would cause silent field loss during JWT
// deserialization.
...
// tag name (e.g. "lid", "max_monitored_systems") → grantField for the specified struct type.
...
// "max_monitored_systems,omitempty" → "max_monitored_systems"
