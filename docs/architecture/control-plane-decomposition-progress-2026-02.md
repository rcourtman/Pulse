...
### Implementation
- [ ] Monitoring/resource route registrations moved to dedicated module.
- [ ] Compatibility aliases preserved.
- [ ] Scope and auth wrappers preserved.
- [ ] Alerts/resources/charts route tests updated for parity.

### Required Tests
- [ ] `go test ./internal/api/... -run "Charts|Resources|Backups|AlertsEndpoints" -v` passed.
