# Pulse v6.4.0-rc.2 Release Notes

`v6.4.0-rc.2` is a release candidate for the next v6 minor release. It improves large-estate performance, notification visibility, agent recovery and subscription options, while carrying forward the latest stable fixes.
