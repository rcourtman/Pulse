...
This changelog describes the changes since `v6.4.1`. It carries the complete
`v6.4.2` change set and the inherited published preview repairs. The previous
published preview is `v6.4.4-beta.2`; beta.3 and beta.4 did not publish and beta.5
was withdrawn. This version does not claim those failed checks were cleared.
