...
- An advisory beta.2 comparison measured a slower metrics-store statistics
  handler that was not changed by its tenant-isolation repair. No user-facing
  regression is demonstrated, but the uncertainty remains open before RC.
