...
_The `v6.4.0-rc.9` release staged an immutable draft, tag, and exact-version artifacts but did not activate publicly. This candidate therefore carries the complete customer-visible change set forward from `v6.4.0-rc.6`._
...
- Release backend qualification allows bounded setup and cleanup overhead beyond the complete race-enabled Go suite, preventing a passed test graph from being cancelled at the former 20-minute job ceiling.
...
- Version: `v6.4.0-rc.10`
- Previous qualification attempt: `v6.4.0-rc.9` (immutable draft, not publicly activated)
- Previous candidate tag: `v6.4.0-rc.9`
