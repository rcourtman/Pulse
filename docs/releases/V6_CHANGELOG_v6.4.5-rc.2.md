...
adds the deferred alerting, Proxmox LXC memory, AI Patrol, PBS Verify SSL and
...
- Previous candidate: `v6.4.5-rc.1`, published 2026-09-22. This cut adds the
  deferred alerting, Proxmox LXC memory, AI Patrol and PBS Verify SSL fixes and
  the release-line qualification correction to the rc.1 candidate
