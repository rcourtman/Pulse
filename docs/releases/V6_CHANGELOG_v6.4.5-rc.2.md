...
This changelog describes the changes since `v6.4.5-rc.1`. This candidate
adds the notification startup-ordering correction, the escalation-admission and
auto-acknowledgement retention backport, the resource-drawer tab retention fix,
and the deferred alerting, Proxmox LXC memory, AI Patrol, PBS Verify SSL and
release-line qualification corrections listed below. This candidate carries the
complete `v6.4.2` change set recorded in `V6_CHANGELOG_v6.4.2.md`, which was
staged but never activated as a public release, plus the corrections already
exercised across the published `v6.4.5` preview checkpoints.
...
- Version: `v6.4.5-rc.2`
- Previous candidate: `v6.4.5-rc.1`, published 2026-09-22. This cut adds the
  notification startup-ordering correction, the escalation-admission and
  auto-acknowledgement retention backport and the resource-drawer tab retention
  fix to the rc.1 candidate, together with the deferred alerting, Proxmox LXC
  memory, AI Patrol and PBS Verify SSL fixes and the release-line qualification
  correction
