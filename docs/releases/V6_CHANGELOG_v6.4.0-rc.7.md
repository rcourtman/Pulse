...
_This changelog describes the changes since `v6.4.0-rc.6` included in
`v6.4.0-rc.7`._
...
- Version: `v6.4.0-rc.7`
- Previous candidate tag: `v6.4.0-rc.6`
...
- Mobile decision: `existing-mobile-build-compatible`. Published iOS build 12 and Android versionCode 9 already route `action_type=view_alert`, which is the action used by the new `alert_fired` push type, so no companion upload is required.
