...
_This changelog describes the changes since `v6.4.0-rc.1` included in
`v6.4.0-rc.2`. It also re-lists fixes first shipped on the `v6.3.2` stable
patch line where they remain part of the next minor release._
...
- Version: `v6.4.0-rc.2`
- Previous candidate: `v6.4.0-rc.1`
