...
For the active prerelease `v6.4.5-rc.2` cut, the repo-root compose default and `scripts/install-docker.sh` fallback must both pin `6.4.5-rc.2` until the next governed stable cut moves them forward.
