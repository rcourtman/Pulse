...
memory values. Docker / Podman, Kubernetes, Standalone, TrueNAS, and vSphere
platform tables must compose those helpers instead of declaring local
`metricFallback` or `finiteMetric` helpers.
