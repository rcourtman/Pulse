...
- Rehearsal date: 2026-07-03
- Result: pass
- GitHub Actions run URL: https://github.com/rcourtman/Pulse/actions/runs/28683144630
- Source branch: pulse/v6-release
- Source commit: 5e9a94d375674e8f29f5b781b0ed12e4099593f6
...
- Prerelease soak hours at rehearsal time: 137
- Exact GA date to publish: 2026-07-03
- Exact v5 end-of-support date to publish: 2026-10-01
- Dry-run artifact source: `/var/folders/vg/9hdntqw90fn2662q1nsqrmh80000gn/T/rc-to-ga-rehearsal.jablgv4n/rc-to-ga-rehearsal-summary.md`
- Hotfix exception: false
- Workflow operator note: Governed release rehearsal for 6.0.0 on 2026-07-03
...
- Workflow run: https://github.com/rcourtman/Pulse/actions/runs/28683144630
...
- Prerelease soak hours at rehearsal time: 137
- Planned GA date: 2026-07-03
- Planned v5 end-of-support date: 2026-10-01
- Hotfix exception: false
- Operator note: Governed release rehearsal for 6.0.0 on 2026-07-03
...
`python3 scripts/release_control/record_rc_to_ga_rehearsal.py --run-id 28683144630`
