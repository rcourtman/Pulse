...
Pulse Mobile does not need desktop parity to stop blocking v6 prerelease stabilization.
...
4. The mobile app provides useful post-pairing navigation for the v6 prerelease line:
...
surface expansion remain post-prerelease and post-GA scope, not v6 prerelease blockers.
...
- Pulse Mobile is judged useful enough for the v6 prerelease line on the narrower floor
  above.
- Future mobile polish and deeper parity work should be captured as post-prerelease or
  post-GA targets instead of blocking prerelease stabilization by default.
