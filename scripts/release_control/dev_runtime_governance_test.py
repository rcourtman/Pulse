...
class DevRuntimeGovernanceTest(unittest.TestCase):
    ...
    def test_lookup_maps_dev_agent_deploy_helper_to_installability(self) -> None:
        result = lookup_paths(["scripts/dev-deploy-agent.sh"])
        self.assertEqual(result["unowned_runtime_files"], [])
        self.assertEqual(
    ...
    def test_lookup_maps_release_promotion_runbook_and_dispatch_checker_to_installability(self) -> None:
        result = lookup_paths(
            [
