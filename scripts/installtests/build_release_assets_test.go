...
func TestCurrentStablePatchReleasePacketTracksInstallMetadata(t *testing.T) {
	...
	assertFileContainsAllNormalized(t, releaseNotesPath,
		...
		"Windows Unified Agent binaries are not Authenticode-signed for `v"+version+"`",
		"Unknown Publisher warning",
		"exact-SHA candidate binding",
		"`no-mobile-impact`",
	...
	assertFileContainsAllNormalized(t, changelogPath,
		...
		"Windows signing decision: the standing SignPath-unavailable policy publishes unsigned Windows",
		"Unknown Publisher warning",
		"exact-SHA candidate binding",
