...
func TestCurrentSupportPrereleasePacketTracksInstallMetadata(t *testing.T) {
	...
	assertFileContainsAllNormalized(t, releaseNotesPath,
		...
		"## Highlights",
		"stable `v"+previous+"`",
		"supersedes `v6.1.0-rc.3`",
		"canonical Operational Trust workflow",
		"Patrol attention workbench",
		"protection and availability",
		"reviewed lifecycle",
		"independent verification",
		"report-only Unified Agent observer destinations",
		"without giving observers command",
		"destination has its own identity, token, retry state, health metric",
		"plaintext-HTTP policy",
		"Mobile chat can propose typed work while keeping approval mandatory",
		"Assistant panel can be resized",
		"PBS datastores are deduplicated",
		"Remember-me browser sessions survive",
		"Observer acknowledgements cannot change",
		"Pulse Mobile iOS candidate build 10 and Android candidate versionCode 8",
		"9b78b108-2586-4b0f-91d3-afbed19b49b3",
		"runtime version 1",
	...
	assertFileContainsAllNormalized(t, changelogPath,
		...
		"Canonical Operational Trust lifecycle evidence",
		"Protection posture and availability facets",
		"Patrol attention workbench",
		"Governed Docker restart review",
		"Report-only Unified Agent observer destinations",
		"Mobile typed-action proposals behind mandatory approval",
		"Alert detection, activation, notification, and resolution",
		"Assistant width is user-adjustable",
		"High-percentage thresholds remain valid",
		"PBS datastore identities",
		"Stale Docker host records",
		"Every non-loopback plaintext observer destination requires explicit",
		"Observer acknowledgements cannot replace",
		"Mobile companion candidates: iOS build 10 and Android versionCode 8",
		"candidate OTA channel at runtime version 1",
	)
	assertFileContainsAll(t, repoFile("docs", "RELEASE_NOTES.md"),
		"docs/releases/RELEASE_NOTES_v"+version+".md",
		"docs/releases/V6_CHANGELOG_v"+version+".md",
