...
func TestCurrentSupportPrereleasePacketTracksInstallMetadata(t *testing.T) {
	...
	assertFileContainsAllNormalized(t, releaseNotesPath,
		...
		"typed proposal-to-action lifecycle",
		"Patrol action state",
		"Pulse Mobile approve or reject flows",
		"capability catalog",
		"Docker and Kubernetes operations",
		"guided Ollama quickstart",
		"monitor-first attention",
		"provider MSP portal",
		"Native updates self-test",
		"silent edition downgrades",
		"Legacy OIDC callbacks",
		"Windows service recovery",
		"fail closed",
		"supersedes `v6.1.0-rc.2`",
		"carries the command permission",
		"namespace-suffixed member references",
		"API shapes TrueNAS actually serves",
		"notify through the same channels as alerts",
		"select releases by highest version",
	...
	assertFileContainsAllNormalized(t, changelogPath,
		...
		"explicit detection and investigation profiles",
		"typed action proposals",
		"canonical pending-action queue",
		"authoritative audit",
		"Simultaneous provider/runtime",
		"Docker and Kubernetes actions verify",
		"guided Ollama `qwen3:8b` quickstart",
		"monitor-first across the main product surfaces",
		"provider MSP portal now uses product design tokens",
		"Replacement binaries are self-tested",
		"block silent Pro-to-community downgrades",
		"Docker and Kubernetes agent liveness handles clock skew",
		...
		"supersedes `v6.1.0-rc.2`",
		"command-execution scope the",
		"namespace-suffixed by-id",
		"API shapes TrueNAS actually serves",
		"route to the configured alert notification channels",
		"select releases by highest version",
		"Claude subscription-backed models",
