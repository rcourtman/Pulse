...
func TestCurrentSupportPrereleasePacketTracksInstallMetadata(t *testing.T) {
	...
	assertFileContainsAllNormalized(t, releaseNotesPath,
		...
		"## Highlights",
		"stable `v"+previous+"`",
		"supersedes `v6.2.0-rc.2`",
		"clusters in different organizations stay separate",
		"internal Proxmox cluster name",
		"node names, and private IP addresses",
		"Captured TLS certificate fingerprints",
		"add-connection path",
		"same identity decision as configuration consolidation",
	...
	assertFileContainsAllNormalized(t, changelogPath,
		...
		"This changelog describes the changes since `v6.2.0-rc.2`",
		"Same-named Proxmox clusters from different organizations remain distinct",
		"overlapping node names and private addresses",
		"contradicting TLS certificate fingerprints",
		"connection add handler",
		"shared identity predicate",
		"regression test reproduces the reported sequence",
