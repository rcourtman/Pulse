...
func TestCurrentPrereleasePacketTracksInstallMetadata(t *testing.T) {
	...
	assertFileContainsAllNormalized(t, changelogPath,
		...
		"least-privilege Unified Agent install profile",
		"Saved views have been removed",
		"4.75 MB to 4.09 MB",
		"Metrics-history retention releases oversized backing arrays",
		"Patrol retries provider initialisation",
		"backup roll-ups derive `totalPages`",
