...
func TestCurrentSupportPrereleasePacketTracksInstallMetadata(t *testing.T) {
	...
	assertFileContainsAllNormalized(t, releaseNotesPath,
		...
		"## Highlights",
		"stable `v"+previous+"`",
		"supersedes `v6.2.0-rc.4`",
		"monitor local libvirt domains and XCP-ng pools",
		"NVIDIA GPU telemetry on Windows",
		"secure custom numeric sensors or REST-backed custom metrics",
		"every filesystem attached to an LXC guest",
		"resource-tag delivery routing",
		"OpenShift-safe Helm profile",
		"`external_probe_offline`",
	...
	assertFileContainsAllNormalized(t, changelogPath,
		...
		"This changelog describes the changes since `v6.2.0-rc.4`",
		"Unified Agent monitoring for local libvirt domains and XCP-ng pools",
		"Windows NVIDIA GPU metrics",
		"Secure local numeric sensors and authenticated REST custom metrics",
		"Resource-tag alert delivery routing",
		"OpenShift-safe Helm deployment profile",
