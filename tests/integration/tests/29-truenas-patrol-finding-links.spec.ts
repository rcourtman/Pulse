...
test.describe("TrueNAS patrol finding links", () => {
  ...
  test("keeps TrueNAS Patrol findings on canonical surface handoff routes", async ({
    page,
  }) => {
          ...
          findings: [
            {
              ...
              description:
                "Pulse Patrol detected that the TrueNAS appliance stopped reporting.",
            ...
            },
            {
              ...
              description:
                "Pulse Patrol detected repeated readiness probe failures.",
    ...
    await expect(
      systemFinding.getByRole("link", {
        name: "Open related workloads for TrueNAS Main",
      }),
    ).toHaveAttribute(
      "href",
    ...
    await expect(
      systemFinding.getByRole("link", {
        name: "Open related storage for TrueNAS Main",
      }),
    ).toHaveAttribute("href", "/storage?source=truenas&node=truenas-main");
    await expect(
      systemFinding.getByRole("link", {
        name: "Open related recovery for TrueNAS Main",
      }),
    ...
    await expect(
      appFinding.getByRole("link", {
        name: "Open related workloads for Nextcloud",
      }),
    ).toHaveAttribute(
      "href",
