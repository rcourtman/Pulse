...
type fixedMonitorResolver struct {
	monitor *monitoring.Monitor
}

func (r fixedMonitorResolver) MonitorForContext(context.Context) *monitoring.Monitor {
	return r.monitor
}
...
func TestHandleCharts_Success(t *testing.T) {
	...
	service := NewService(fixedMonitorResolver{monitor: monitor})

	req := httptest.NewRequest(http.MethodGet, "/api/charts?range=5m", nil)
	rec := httptest.NewRecorder()

	service.HandleCharts(rec, req)
...
func TestHandleInfrastructureCharts_Lightweight(t *testing.T) {
	...
	service.HandleInfrastructureCharts(rec, req)
...
func TestHandleWorkloadsSummaryCharts_AggregatesAndCounts(t *testing.T) {
	...
	service.HandleWorkloadsSummaryCharts(rec, req)
	...
	service.HandleWorkloadsSummaryCharts(nodeRec, nodeReq)
...
func TestHandleWorkloadCharts_WorkloadOnlyPayloadAndNodeFilter(t *testing.T) {
	...
	rec := httptest.NewRecorder()
	service.HandleWorkloadCharts(rec, req)
	...
	nodeRec := httptest.NewRecorder()
	service.HandleWorkloadCharts(nodeRec, nodeReq)
...
func TestHandleStorageCharts_Success(t *testing.T) {
	...
	service.HandleStorageCharts(rec, req)
...
func TestHandleStorageSummaryCharts_AggregatesCapacityAcrossPools(t *testing.T) {
	...
	service.HandleStorageSummaryCharts(rec, req)
