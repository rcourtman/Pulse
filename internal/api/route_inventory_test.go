...
var allRouteAllowlist = []string{
	...
	"POST /api/resources/{id}/maintenance-verifications/rerun",
	...
	"POST /api/orgs/{id}/shares/incoming/{shareId}/accept",
	"POST /api/orgs/{id}/shares",
	"DELETE /api/orgs/{id}/shares/incoming/{shareId}",
	...
	"/api/ai/workflow-prompts/render",
