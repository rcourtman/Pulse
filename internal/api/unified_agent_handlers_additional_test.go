...
func TestUnifiedAgentHandlers_HandleReportMethodNotAllowed(t *testing.T) {
...
func TestUnifiedAgentHandlers_HandleReportInvalidJSON(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t)
...
func TestUnifiedAgentHandlers_HandleReportInvalidReport(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t)
...
func TestUnifiedAgentHandlers_HandleReportIncludesConfigOverride(t *testing.T) {
...
func TestUnifiedAgentHandlers_HandleAllowReenrollErrors(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t)

	req := httptest.NewRequest(http.MethodGet, "/api/agents/agent/host-1/allow-reenroll", nil)
	rec := httptest.NewRecorder()
	...
	req = httptest.NewRequest(http.MethodPost, "/api/agents/agent//allow-reenroll", nil)
	rec = httptest.NewRecorder()
	handler.HandleAllowReenroll(rec, req)
	if rec.Code != http.StatusBadRequest {
		t.Fatalf("expected status %d, got %d", http.StatusBadRequest, rec.Code)
...
func TestUnifiedAgentHandlers_HandleConfigErrors(t *testing.T) {
...
func TestUnifiedAgentHandlers_HandleConfigPatchErrors(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t)
...
func TestUnifiedAgentHandlers_EnsureAgentTokenMatchScopes(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t)
...
func TestUnifiedAgentHandlers_HandleConfigSigningRequiredMissingKey(t *testing.T) {
...
func TestUnifiedAgentHandlers_HandleConfigSigningSuccess(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t, models.Host{ID: "host-1"})
...
func TestUnifiedAgentHandlers_HandleUninstallErrors(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t)
...
func TestUnifiedAgentHandlers_HandleUninstallMissingHostStillSucceeds(t *testing.T) {
...
func TestUnifiedAgentHandlers_HandleLinkUnlinkErrors(t *testing.T) {
	handler := newUnifiedAgentHandlerForTests(t)
