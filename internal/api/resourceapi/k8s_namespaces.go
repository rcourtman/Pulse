...
func emptyK8sNamespacesResponse() k8sNamespacesResponse {
	return k8sNamespacesResponse{}.normalizeCollections()
}

func (r k8sNamespacesResponse) normalizeCollections() k8sNamespacesResponse {
	if r.Data == nil {
		r.Data = []k8sNamespaceSummary{}
	}
	return r
}
...
func (h *QueryService) HandleK8sNamespaces(w http.ResponseWriter, r *http.Request) {
	...
	response := emptyK8sNamespacesResponse()
