...
var agentCapabilitiesManifest = AgentCapabilitiesManifest{
	...
	Capabilities: []AgentCapability{
		...
		},
		{
			...
			ErrorCodes:       []string{"missing_id", "invalid_id", "invalid_action_execution", "action_not_found", "action_not_approved", "action_already_executing", "action_execution_final", "action_dry_run_only", "action_plan_drift", "action_executor_unavailable"},
		},
	},
}
