...
func TestParseResourceTypesNodeAlias(t *testing.T) {
	tests := []struct {
		...
		{name: "k8s replicaset", input: "k8s-replicaset", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sReplicaSet: {}}},
		...
		{name: "k8s endpoint slice", input: "k8s-endpoint-slice", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sEndpointSlice: {}}},
		{name: "k8s network policy", input: "k8s-network-policy", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sNetworkPolicy: {}}},
		...
		{name: "k8s storage class", input: "k8s-storage-class", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sStorageClass: {}}},
		{name: "k8s configmap", input: "k8s-configmap", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sConfigMap: {}}},
		{name: "k8s secret", input: "k8s-secret", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sSecret: {}}},
		{name: "k8s serviceaccount", input: "k8s-serviceaccount", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sServiceAccount: {}}},
		{name: "k8s resource quota", input: "k8s-resource-quota", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sResourceQuota: {}}},
		{name: "k8s limit range", input: "k8s-limit-range", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sLimitRange: {}}},
		{name: "k8s pod disruption budget", input: "k8s-pod-disruption-budget", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sPDB: {}}},
		{name: "k8s horizontal pod autoscaler", input: "k8s-horizontal-pod-autoscaler", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sHPA: {}}},
		{name: "k8s hpa alias", input: "k8s-hpa", want: map[unified.ResourceType]struct{}{unified.ResourceTypeK8sHPA: {}}},
