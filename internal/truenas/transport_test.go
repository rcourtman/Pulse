...
// Issue #1631 handshake-redirect coverage: the v6.1.2 JSON-RPC migration
// broke http-configured appliances behind TrueNAS's HTTP -> HTTPS redirect.
// The websocket dial must upgrade a same-host https redirect to wss itself
// and refuse anything that would move the connection to another host.
