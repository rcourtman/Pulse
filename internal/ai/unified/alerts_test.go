...
func TestGenerateImpact_AuthorsConsequenceForKnownAlertTypes(t *testing.T) {
	cases := []struct {
		...
		{"docker-host-offline", "unreachable"},
		{"connectivity", "unreachable"},
		{"poweredOff", "unavailable"},
		{"powered-off", "unavailable"},
		{"zfs-pool-state", "data integrity"},
		{"zfs-pool-errors", "data integrity"},
		{"zfs-device", "pool failure"},
		{"storage-topology", "capacity"},
		{"disk-health", "data loss"},
		{"disk-wearout", "data loss"},
		{"raid", "redundancy"},
		{"diskRead", "queue"},
		{"diskWrite", "queue"},
		{"networkIn", "latency"},
		{"networkOut", "latency"},
		{"backup-age", "cannot be recovered"},
		{"snapshot-age", "stale"},
		{"snapshotSize", "capacity"},
		{"oom", "terminate"},
		{"docker-container-oom-kill", "terminate"},
		{"restartLoop", "stable state"},
		{"docker-container-restart-loop", "stable state"},
		{"imageUpdateAvail", "vulnerabilities"},
		{"docker-container-update", "vulnerabilities"},
		{"docker-container-health", "cannot serve"},
		{"docker-service-health", "cannot serve"},
		{"docker-container-state", "cannot serve"},
		{"docker-container-memory-limit", "OOM"},
		{"message-age", "unknown"},
	}
