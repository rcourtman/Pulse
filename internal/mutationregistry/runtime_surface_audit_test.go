...
func TestTransportCommandCatalogsResolveToRegistry(t *testing.T) {
	...
	agentCatalog := map[string]transportClassification{
		...
		"MsgTypeDockerContainerObserveResult":   {Role: TransportRoleOperationResult},
		"MsgTypeProxmoxGuestLifecycleResult":    {Role: TransportRoleOperationResult},
		...
		"MsgTypeProxmoxGuestLifecycle":    {Role: TransportRoleMutationRequest, MutationID: "transport.agent.proxmox-guest-lifecycle", DurableAuthorityID: "resource.proxmox.guest-lifecycle"},
		...
		"MsgTypeDockerContainerObserve":   {Role: TransportRoleOperationQuery},
