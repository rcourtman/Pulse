...
func (v VM) ToFrontend() VMFrontend {
	vm := VMFrontend{
		...
		GuestAgentStatus:   v.GuestAgentStatus,
		GuestAgentExpected: v.GuestAgentExpected,
	}
...
func ConvertResourceToFrontend(input ResourceConvertInput) ResourceFrontend {
	rf := ResourceFrontend{
		...
		AISafeSummaryRef:      input.AISafeSummaryRef,
	...
	if input.DiskReadRate != nil || input.DiskWriteRate != nil {
