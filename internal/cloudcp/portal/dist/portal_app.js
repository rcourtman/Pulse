(() => {
  ...
  function renderAccountOverviewSection(account) {
    ...
    var accountScopeCopy = account.kind === "msp" ? "Run client workspaces, account billing, and team access from one place." : "Run hosted workspaces, account billing, and team access from one place.";
    var overviewBriefStrip = '<div class="account-overview-brief-strip"><div class="account-overview-brief-point account-overview-brief-point-wide"><strong>Account role</strong><span>' + escapeHTML(accountScopeCopy) + '</span></div><div class="account-overview-brief-point"><strong>Hosted path</strong><span>Use Workspaces for tenant access and lifecycle changes, and Team only when access needs to change.</span></div><div class="account-overview-brief-point"><strong>Commercial path</strong><span>Keep licenses, refunds, privacy, and self-hosted billing in Account services instead of mixing them into hosted work.</span></div></div>';
