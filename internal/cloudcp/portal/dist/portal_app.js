(() => {
  ...
  function renderAuthenticatedPortalHTML(context) {
    ...
    var billingNote = hosted ? "Use hosted billing first when the request belongs to a hosted workspace account. Self-hosted licenses, refunds, and privacy stay separate underneath it." : "Use this billing surface only for self-hosted subscriptions, licenses, refunds, and privacy requests.";
