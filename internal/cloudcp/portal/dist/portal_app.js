(() => {
  ...
  function renderAccountOverviewSection(account) {
    ...
    ]) + renderOverviewMetricStrip(totalCount, readyCount, checkingCount, unhealthyCount, suspendedCount) + '</div></div><div class="account-command-deck"><div class="account-overview-main-column"><div class="account-overview-card account-overview-briefing-card"><div class="account-overview-lead"><div class="account-panel-kicker">Fleet posture</div><h3>' + escapeHTML(postureTitle) + "</h3><p>" + escapeHTML(postureCopy) + '</p><div class="account-overview-callout">' + escapeHTML(
    ...
    ) + '</div></div><div class="account-overview-next-block"><div class="account-panel-kicker">Next move</div><h4>' + escapeHTML(nextStepTitle) + "</h4><p>" + escapeHTML(nextStepCopy) + "</p>" + nextStepChecklist + nextStepActions + '</div></div></div><div class="account-overview-side-column">' + renderAttentionPanel(workspaces) + "</div></div></section>";
  }
