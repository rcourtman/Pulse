...
function renderSupportSection(context: ShellViewContext): string {
  ...
  var providerOpsRow = context.bootstrap.provider_hosted_mode === true
    ? '<div class="portal-support-simple-row"><strong>Operations guide</strong><span>Backups, upgrades, firewall baseline, and the validation checklist live in <a href="https://github.com/rcourtman/Pulse/blob/main/docs/MSP.md" target="_blank" rel="noopener">docs/MSP.md</a> in the Pulse repository.</span></div>'
    : '';
  return (
