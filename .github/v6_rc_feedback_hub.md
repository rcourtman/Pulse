...
- upgrade failures
- crashes, broken flows, or data-risk issues
- anything that needs direct tracking to closure

When you comment here, please include:

- Pulse version
- whether this was a clean v6 install or an upgrade
- OS or environment
- license tier
- what you expected
- what happened instead
- screenshots or sanitized logs if they help

Please keep one comment per topic so I can track follow-ups cleanly.
